...
export default function InicioPage() {
    ...
    useEffect(() => {
        axios.get('https://fjrg.byethost7.com/GestionAlmacenamiento/backend/api/mapas.php')
    ...
    const handleCrearMapa = () => {
        ...
        if (nombreMapa && nombreMapa.trim() !== '') {
            const apiUrl = 'https://fjrg.byethost7.com/GestionAlmacenamiento/backend/api/crear_mapa.php';
    ...
    const handleModificarMapa = () => {
        ...
        if (nuevoNombre && nuevoNombre.trim() !== '') {
            const apiUrl = 'https://fjrg.byethost7.com/GestionAlmacenamiento/backend/api/modificar_mapa.php';
    ...
    const handleEliminarMapa = () => {
        ...
        if (idParaEliminar && !isNaN(idParaEliminar)) {
            if (window.confirm(`¿Estás seguro de que quieres eliminar el mapa con ID ${idParaEliminar}?`)) {
                const apiUrl = 'https://fjrg.byethost7.com/GestionAlmacenamiento/backend/api/eliminar_mapa.php';
